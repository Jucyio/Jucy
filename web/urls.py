...
urlpatterns = patterns('',
    ...
    # url(r'^%s/_ajax/issue/%s/reject$' % (github_user_repo_regex, github_issue_id),
    #     views.reject_idea, name='reject_idea'),
    # url(r'^%s/_ajax/issue/%s/approve$' % (github_user_repo_regex, github_issue_id),
    #     views.approve_idea, name='approve_idea'),
    # url(r'^%s/_ajax/issue/%s/duplicate$' % (github_user_repo_regex, github_issue_id),
